...
import com.emre.javamaps.adapter.PlaceAdapter;
import com.emre.javamaps.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        MenuInflater menuInflater = getMenuInflater(); //Inflater - bağlama
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == R.id.add_place) {
            // Hangisine tıklandığını ID'si ile kontrol ediyoruz
